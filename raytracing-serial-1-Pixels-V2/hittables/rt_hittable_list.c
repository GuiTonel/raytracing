                               ...
                               rt_hit_record_t *record)
{
    ...
    // PARALLELIZABLE BUT IT'S NOT GOOD BECAUSE IF THE FIRST ONE IS THE CLOSEST IT'S NOT NECESSARY TO CALCULATE THE RAY FOR THE OTHERSÇ
    // IT CAN BE IF CHANGE THE HIT FUNCTION BUT IT'S DIFFERENT FOR EACH OBJECT SO IT IS NOT WORTH
    for (size_t i = 0; i < list->size; ++i)
    {
